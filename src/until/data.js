const data = [
  ...
  category: "computers & tablets"
   ...
   {
      description: "Redmi PadAll in one, pad for fun90Hz buttery smooth displayHigh-performance MediaTek Helio G99Long-lasting 8000mAh batteryFlagship-level unibody design",
      spec: [
        "{Size: 10.61 display}",
  ...
  spec: [
    ...
    {audio:"Enjoy enhanced sound from the system’s onboard speakers when playing in Handheld and Tabletop modes."}
        ],
